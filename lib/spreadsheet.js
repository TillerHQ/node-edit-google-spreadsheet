...
Spreadsheet.prototype.format = function() {
  var scriptId = 'MCxQrS8nXuvz4jimmBFcA3R1FXtTaoTlN';
  ...
  script.scripts.run({
    ...
    resource: {
      function: 'formatCell',
      parameters: [
        '1N3w70zoKw-G3VwWv6hXpP1sBmOgX2ymeDuIFdT16ias',
        "B2",
        "0.0"
      ],
    },
    ...
    if (resp.error) {
      ...
      console.log('Go check out the sheet.');
    }
